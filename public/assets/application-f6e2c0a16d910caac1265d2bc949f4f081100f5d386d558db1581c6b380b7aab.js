...
(function() {
  $(document).on("turbolinks:load", function() {
    if ($(".messages.show").length > 0) {
      return App.chat = App.cable.subscriptions.create("ChatChannel", {
        connected: function() {},
        ...
        received: function(data) {
          ...
          li.textContent = data;
          return document.getElementById('message-list').appendChild(li);
        },
        put_message: function(msg) {
          return this.perform('put_message', {
            message: msg
          });
        }
      });
...
(function() {
  $(document).on("turbolinks:load", function() {
    if ($(".locations.show").length > 0) {
      return App.locate = App.cable.subscriptions.create("LocateChannel", {
        connected: function() {},
        disconnected: function() {},
        received: function(data) {
          return add_marker(data);
        },
        put_latlng: function(lat, lng) {
          return this.perform('put_latlng', {
            latitude: lat,
            longitude: lng
          });
        }
